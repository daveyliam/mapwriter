...
public abstract class MwGuiSlot
{
    ...
    protected void drawSelectionBox(int x, int y, int mouseXIn, int mouseYIn)
    {
        ...
        {  
        	int slotHeight = getSlotHeight(index);
            ...
            if (this.showSelectionBox && this.isSelected(index))
            {
                ...
                worldrenderer.addVertexWithUV((double)xLeft, (double)(yTotal + slotHeight), 0.0D, 0.0D, 1.0D);
                worldrenderer.addVertexWithUV((double)xRight, (double)(yTotal + slotHeight), 0.0D, 1.0D, 1.0D);
                worldrenderer.addVertexWithUV((double)xRight, (double)(yTotal), 0.0D, 1.0D, 0.0D);
                worldrenderer.addVertexWithUV((double)xLeft, (double)(yTotal), 0.0D, 0.0D, 0.0D);
                worldrenderer.setColorOpaque_I(0);
                worldrenderer.addVertexWithUV((double)(xLeft + 1), (double)(yTotal + slotHeight - 1), 0.0D, 0.0D, 1.0D);
                worldrenderer.addVertexWithUV((double)(xRight - 1), (double)(yTotal + slotHeight - 1), 0.0D, 1.0D, 1.0D);
                worldrenderer.addVertexWithUV((double)(xRight - 1), (double)(yTotal + 1), 0.0D, 1.0D, 0.0D);
                worldrenderer.addVertexWithUV((double)(xLeft + 1), (double)(yTotal + 1), 0.0D, 0.0D, 0.0D);
                tessellator.draw();
                GlStateManager.enableTexture2D();
            }
    ...
    {
    	return left + this.width - this.scrollBarWidth;
    }
